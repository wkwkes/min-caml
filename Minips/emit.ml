...
<<<<<<< HEAD
let stackset = ref S.empty (* ���Ǥ� Save ���줿�ѿ��ν��� *)
let stackmap = ref [] (* Save ���줿�ѿ��Υ����å��ˤ��������� *)
=======
...
type dest = Tail | NonTail of Id.t (* �������ɤ�����ɽ���ǡ����� *)
let rec g oc = function (* ̿�����Υ������֥����� *)
  | (dest, Ans (exp)) -> g' oc (dest, exp)
  | (dest, Let((x, t), exp, e)) -> g' oc (NonTail (x), exp); g oc (dest, e)
and g' oc = function (* ��̿���Υ������֥����� *)
  (* �����Ǥʤ��ä����׻����̤� dest �˥��å� *)
  | (NonTail(_), Nop) -> ()
...
<<<<<<< HEAD
  ...
  | (NonTail(x), Mul(y, V(z))) -> 
    Printf.fprintf oc "\tmulhw\t%s, %s, %s\n" (reg x) (reg y) (reg z)
  | (NonTail(x), Mul(y, C(z))) -> 
    Printf.fprintf oc "\tmulli\t%s, %s, %d\n" (reg x) (reg y) z
  | (NonTail(x), Div(y, V(z))) -> 
    Printf.fprintf oc "\tdivw\t%s, %s, %s\n" (reg x) (reg y) (reg z)
  | (NonTail(x), Div(y, C(z))) -> 
    Printf.fprintf oc "\tdivw\t%s, %s, %d\n" (reg x) (reg y) z
  | (NonTail(x), Slw(y, V(z))) -> 
